...
public class PacketAutoOverride extends PacketServerOverride implements IMessage
{
	...
	public void setNBTValue(NBTTagCompound tag, String key, Object value)
	{
		...
		{
			EnviroRot.logger.log(Level.ERROR, "Tried to set NBTTagCompound without a value and or key!");
			return;
		}
		...
		{
			EnviroRot.logger.log(Level.ERROR, "Cannot set NBTTagCompound a value type of " + value.getClass().getSimpleName());
		}
	}
