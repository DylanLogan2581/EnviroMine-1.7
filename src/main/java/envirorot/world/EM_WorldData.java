...
public class EM_WorldData extends WorldSavedData {
	...
	public static EM_WorldData get(World world) 
	{
		...
		if (data == null) 
		{
			...
			EnviroRot.logger.log(Level.ERROR, "Envirorot World Data Doesn't Exist. Creating now");
		}
		else EnviroRot.logger.log(Level.INFO, "Loading Envirorot World Data");
