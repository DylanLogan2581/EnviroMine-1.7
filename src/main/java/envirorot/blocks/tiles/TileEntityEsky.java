...
public class TileEntityEsky extends TileEntity implements IInventory
{
	...
	public void updateEntity()
	{
        ...
        if (this.numPlayersUsing > 0 && this.field_145972_a == 0.0F)
        {
            ...
            this.worldObj.playSoundEffect(d0, (double)this.yCoord + 0.5D, d1, "envirorot:eskyopen", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.numPlayersUsing == 0 && this.field_145972_a > 0.0F || this.numPlayersUsing > 0 && this.field_145972_a < 1.0F)
        {
            ...
            if (this.field_145972_a < f1 && f2 >= f1)
            {
                ...
                this.worldObj.playSoundEffect(d1, (double)this.yCoord + 0.5D, d2, "envirorot:eskyclose", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
	...
	{
        return "container.envirorot.esky";
	}
