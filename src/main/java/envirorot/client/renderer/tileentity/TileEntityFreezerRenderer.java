package envirorot.client.renderer.tileentity;
...
{
    private static final ResourceLocation field_147520_b = new ResourceLocation("envirorot", "textures/models/blocks/freezer_model.png");
